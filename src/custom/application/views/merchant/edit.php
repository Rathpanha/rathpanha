...
<div class="wrap-content">
  <div class="measure">
    <h3 class="m0"><?php echo lang("MERCHANT"); ?></h3>
      ...
      <div class="wrap-block col-two">
        <div class="left-block">
          <div class="block border">
            <div class="title"><?php echo lang("Edit Merchant"); ?> <?php sp($merchant->merchant_name); ?></div>

            <label><?php echo lang("Merchant Name"); ?> <span class="fn-red">*</span></label>
            <input type="text" name="name" required autofocus value="<?php sp($merchant->merchant_name); ?>"/>
          </div>
        </div>
      </div>
